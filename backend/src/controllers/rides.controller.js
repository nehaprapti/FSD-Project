...
export const getUserRidesController = async (req, res, next) => {
  try {
    const { userId, role } = req.user;
    const { getUserRides } = await import("../services/rides.service.js");
    const rides = await getUserRides(userId, role);
